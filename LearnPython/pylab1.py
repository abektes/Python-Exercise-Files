...
pylab.figure(1) #figure number 1
...
for i in range (years + 1):
	values1.append(principal1)
	principal1 = principal1 + principal1 * interestRate1

for i in range (years + 1):
	values2.append(principal2)
	principal2 = principal2 + principal2 * interestRate2

pylab.plot(range(years+1), values1)
pylab.plot(range(years+1), values2)
